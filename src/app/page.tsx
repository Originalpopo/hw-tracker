...
export default function DashboardOverview() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      {/* Hero Welcome Card */}
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link href="/homework" className="bg-white text-blue-700 px-6 py-3 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-md active:scale-95 flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-3 bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col justify-center">
          <div className="flex justify-between items-end mb-4">
            ...
            <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-green-600">
              {progressPercent}%
            </div>
          </div>
          ...
          <div className="w-full bg-gray-100 rounded-full h-6 shadow-inner mt-2 relative">
            <div 
              className="h-full bg-gradient-to-r from-green-400 to-green-500 rounded-full transition-all duration-1000 ease-out flex items-center justify-end relative"
        ...
        {/* Done Stats */}
        <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-3xl p-6 shadow-sm flex flex-col justify-between relative overflow-hidden text-white">
          <div className="absolute -right-4 -bottom-4 opacity-20">
          ...
          <div className="space-y-3">
            {recentPending.length === 0 ? (
              ...
              recentPending.map(task => (
                <div key={task.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-blue-200 transition-colors">
                  <div className="flex items-center overflow-hidden">
                    <div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center text-orange-600 mr-4 shrink-0 shadow-sm">
                  ...
                  <Link href="/homework" className="bg-white border border-gray-200 text-gray-600 p-2 rounded-full hover:bg-blue-50 hover:text-blue-600 transition-colors shrink-0 ml-4">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {subjects.map(subject => {
            ...
            return (
              <div key={subject} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex flex-col justify-center transition-all hover:shadow-md hover:border-blue-100">
                ...
                <div className="w-full bg-gray-100 rounded-full h-3 overflow-hidden shadow-inner">
                  <div 
                    className={clsx(
                      ...
                      percent === 100 ? "bg-green-500" : "bg-gradient-to-r from-blue-400 to-blue-600"
                    )}
                    style={{ width: `${percent}%` }}
                  >
                  </div>
